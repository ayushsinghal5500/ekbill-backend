...
export const insertQuickBill = async (client, bill) => {
  ...
  await client.query(
    `INSERT INTO ekbill.quick_bills (
      ...
      customer_gstin, billing_address, billing_user_phone, notes, invoice_date, due_date,subtotal, has_discount, has_gst,
    ...
    [quick_bill_unique_code, bill.business_unique_code, bill.invoice_name,bill.customer_name || null, bill.customer_phone || null, bill.customer_country_code || null,
      bill.customer_gstin || null, bill.billing_address || null, bill.billing_user_phone || null,bill.notes || null, bill.invoice_date || null, bill.due_date || null,
